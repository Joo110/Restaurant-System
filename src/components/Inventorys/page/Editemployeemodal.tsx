...
// Mock employee data - in real app you'd fetch by id from useParams
const employee = {
  name: "Mohamed Morsy",
        ...
        <div className="border-t border-slate-100 pt-5 space-y-4">
          ...
          <div className="flex flex-col items-center gap-3 mb-2">
            <div className="relative">
              ...
              <button className="absolute -bottom-1 -right-1 w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs">
                ✏
              </button>
            </div>
