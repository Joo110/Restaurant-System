                ...
                <tbody>
                  {mockEmployees
                    ...
                    .map((emp) => (
                      ...
                      >
                        <td className="py-3 px-4 text-slate-700 font-medium whitespace-nowrap">{emp.name}</td>
                        <td className="py-3 px-4 text-slate-600 whitespace-nowrap">{emp.jobTitle}</td>
