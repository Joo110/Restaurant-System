      ...
      <div className="grid grid-cols-4 gap-3 mb-5">
        {stats.map((s) => (
          <div key={s.label} className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4">
            ...
            <p className={`text-2xl font-bold ${s.text} mb-2`}>
              {s.value} <span className="text-sm font-normal text-slate-400">/ {s.total}</span>
            </p>
        ...
        <table className="w-full text-sm">
          <thead className="border-b border-slate-100 bg-slate-50">
            <tr className="text-xs text-slate-500 font-semibold uppercase tracking-wide">
              ...
              <th className="py-3 px-5 text-left">Total Hours</th>
            ...
            {records
              ...
              .map((r) => (
                ...
                >
                  ...
                  <td className="py-3 px-5 text-slate-600">{r.checkIn}</td>
                  <td className="py-3 px-5 text-slate-600">{r.checkOut}</td>
                  <td className="py-3 px-5 text-slate-600">{r.totalHours}</td>
