        ...
        <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-5 mb-4">
          <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
            ...
            <button
              ...
              className="w-full sm:w-auto flex items-center justify-center gap-1.5 px-3 py-2 bg-blue-500 text-white rounded-xl text-sm font-semibold hover:bg-blue-600 transition-colors"
            >
              ▶ Process Payroll
            </button>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-700 font-medium break-all">Mohamed@66gmail.com</p>
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 sm:p-5">
            ...
            <div className="grid grid-cols-3 gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-700 font-medium break-all">20202154441</p>
              </div>
            </div>
